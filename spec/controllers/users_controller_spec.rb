...
describe UsersController do
	...
	describe "GET 'new'" do
		...
		it "devrait avoir un champ poids" do
			get(:new)
			response.should(have_selector("input[name='user[poids]'][type='text']"))
		end

		it "devrait avoir un champ poids idéal" do
			get(:new)
			response.should(have_selector("input[name='user[poids_ideal]'][type='text']"))
		end
		...
		it "devrait avoir un champ fumeur" do
			get(:new)
			response.should(have_selector("input[name='user[fumeur]'][type='checkbox']"))
		end

		it "devrait avoir un champ Souhaite arreter" do
			get(:new)
			response.should(have_selector("input[name='user[souhaite_arreter]'][type='checkbox']"))
		end
	...
	describe "GET 'show'" do
		...
		it "devrait afficher le nom" do
			get(:show, :id => @user.id)
			response.should(have_selector("strong", :content => "Nom"))
		end

		it "devrait afficher l'url" do
			get(:show, :id => @user.id)
			response.should(have_selector("strong", :content => "URL"))
		end

		it "devrait afficher l'âge" do
			get(:show, :id => @user.id)
			response.should(have_selector("strong", :content => "Age"))
		end

		it "devrait afficher le poids" do
			get(:show, :id => @user.id)
			response.should(have_selector("strong", :content => "Poids"))
		end

		it "devrait afficher le poids idéal" do
			get(:show, :id => @user.id)
			response.should(have_selector("strong", :content => "Poids idéal"))
		end

		it "devrait afficher la taille" do
			get(:show, :id => @user.id)
			response.should(have_selector("strong", :content => "Taille"))
		end

		it "devrait afficher l'imc" do
			get(:show, :id => @user.id)
			response.should(have_selector("strong", :content => "IMC"))
		end

		it "devrait afficher la mention je suis fumeur" do
			get(:show, :id => @user.id)
			response.should(have_selector("strong", :content => "Je suis fumeur"))
		end

		it "devrait afficher la mention j'aimerais arrêter lorsque l'utilisateur est fumeur" do
			get(:show, :id => @user.id)
			response.should(have_selector("strong", :content => "J'aimerais arrêter"))
		end
